...
layout (location = 0) out vec4 rtFragColorPos;
layout (location = 1) out vec4 rtFragColorNorm;
layout (location = 2) out vec4 rtFragColorTexCoord;
...
{
	//Position
	rtFragColorPos = vPosition;

	//Normal
	rtFragColorNorm = vNormal;

	//Atlas
	rtFragColorTexCoord = vAtlas;
}
