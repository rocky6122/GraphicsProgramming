...
{
	if (material)
		return a3bufferFillOffset(material->uniformBuffer, 0, 0, material->dataSize, material->data, 0);
	return -1;
}
...
{
	if (material)
		return a3bufferFillOffset(material->uniformBuffer, 0, start, size, material->data, 0);
	return -1;
}
...
A3_INLINE a3ret a3materialUploadNew(a3_Material *material, const void *data_opt, const a3ui16 dataSize)
{
	...
	{
		a3i32 ret = a3bufferFillOffset(material->uniformBuffer, 0, 0, dataSize, data_opt, 0);
		if (ret > 0)
		{
