...
A3_INLINE a3ret a3vertexStorageSpaceRequired(const a3_VertexFormatDescriptor *vertexFormat, const a3ui32 count)
{
	if (vertexFormat)
	{
...
A3_INLINE a3ret a3indexStorageSpaceRequired(const a3_IndexFormatDescriptor *indexFormat, const a3ui32 count)
{
	if (indexFormat)
	{
		// padding may be required
