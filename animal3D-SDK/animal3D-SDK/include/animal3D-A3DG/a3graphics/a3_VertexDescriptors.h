...
//-----------------------------------------------------------------------------
	...
	a3ret a3vertexStorageSpaceRequired(const a3_VertexFormatDescriptor *vertexFormat, const a3ui32 count);
	...
	//	return: storage space requirements in bytes
	//	return: -1 if invalid param
	a3ret a3indexStorageSpaceRequired(const a3_IndexFormatDescriptor *indexFormat, const a3ui32 count);
...
//-----------------------------------------------------------------------------
	...
	//	return: -1 if invalid params
	a3ret a3vertexCreateFormatDescriptor(a3_VertexFormatDescriptor *vertexFormat_out, const a3_VertexAttributeDescriptor *attribList, a3ui32 attribCount);
	...
	//	return: -1 if invalid params
	a3ret a3indexCreateFormatDescriptor(a3_IndexFormatDescriptor *indexFormat_out, const a3_IndexType indexType);
