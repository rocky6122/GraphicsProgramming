...
----------------------------------------+--------------------------------------
	"Directory/" or "FILE.type"			|	Description
----------------------------------------+--------------------------------------
-animal3D-SDK/ (root)					|
	...
	-animal3D-SDK/						| (you are here)
		...
		-project/                       | 
			-VisualStudio/              | 
				-_SLN/                  | 
					-animal3d-sdk/      | VS solution (**USE LAUNCHER ONLY**)
				-animal3D-A3DG-OpenGL/  | animal3D OpenGL graphics project
				-animal3D-DemoProject/  | animal3D demo project (**WORK HERE**)
				-animal3D-LaunchApp/    | animal3D launcher app project
		-resource/                      | Loaded assets live here
			-animal3D-data/             | Data for launching animal3D demos
		-source/                        | Source code lives here
			-animal3D-A3DG/             | 
				-a3graphics/            | 
				-a3graphics-OpenGL/     | 
			-animal3D-DemoProject/      | 
				-A3DEMO/                | **YOUR CODE GOES HERE**
			-animal3D-LaunchApp/        | 
...
3. Platform-specific information
	...
	A. Windows
		i.	 IDE: Visual Studio
The supported IDE for Windows is VISUAL STUDIO.
The supported editions are 2017 (15, v141), 2015 (14, v140), 2013 (12, v120), 
and possibly 2012 (11, v110, untested).
...
more of the components therein: 
		...
		iii. Notes
Update since last version: DLL hotbuild should now work in VS2017.
...
The main window of any animal3D demo is a built-in feature. The launcher app's 
...
opens and doesn't go away), navigate to /utility/win/animal3D-VSSetPath/ and 
open either the solution or project; MAKE SURE YOU ARE RUNNING VISUAL STUDIO 
AS AN ADMINISTRATOR FOR THIS! Upgrade build tools if needed (e.g. from v140 
to v141). Simply build the project (while running as admin) and the project 
will force Visual Studio to set a path to itself, permanently. The launcher 
should function as expected after this. Close this project, don't bother 
saving settings if you changed them. Try the launcher again.
...
the files to a new folder. Zip it up and you're golden!
